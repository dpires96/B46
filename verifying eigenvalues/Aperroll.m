...
% Asymmetric: Aper. Roll 1:01 (index around 36510) Dutch Roll 1:03  Dutch Roll YD 1:04  Spiral 1:05

fd =  load('FTISxprt-20200311_flight2');
asym = 1; %0 if symmetric, 1 if assymetric

startindex = 36297; %(Second-9)*10
refindex = 36297; %3 seconds before
...
Cmde   = -1.886;            % elevator effectiveness [ ]
